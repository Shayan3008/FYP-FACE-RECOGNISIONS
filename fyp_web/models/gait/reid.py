from models.gait.torchreid.data.transforms import build_transforms
from PIL import Image
import models.gait.torchreid as torchreid
import torch
from models.gait.torchreid import metrics
...
class REID:
    def __init__(self):
        ...
        torchreid.utils.load_pretrained_weights(
            self.model, './models/gait/model_data/models/model.pth.tar-60')
        if self.use_gpu:
